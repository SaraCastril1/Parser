...
string Code:: value(int direccion){
    ...
    //se implementa el control para no exceder el maximo entero posible en instrucciones de 16-bits
    ...
    if(direccion<=32767){
        ...
        throw "Error: las instrucciones de 16 bits no soportan numeros mayores a 32767";
    }
}
