...
{
private:
    //se decide tomar los siguientes atributos predefinidos
...
public:
    ...
    //solo se cambian ls nombres 
    void anadir(string symbol, int address);     // añade simbolo-dirección a la tabla
